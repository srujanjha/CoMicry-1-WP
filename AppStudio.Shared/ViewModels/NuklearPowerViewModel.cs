...
{
    public class NuklearPowerViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "NuklearPowerDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new NuklearPowerDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("NuklearPowerDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("NuklearPowerList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("NuklearPowerDetail");
        }
    }
}
