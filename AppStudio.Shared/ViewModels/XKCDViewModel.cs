...
{
    public class XKCDViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "XKCDDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new XKCDDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("XKCDDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("XKCDList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("XKCDDetail");
        }
    }
}
