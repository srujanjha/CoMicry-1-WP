...
{
    public class SatMorningBreakfastCerealViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "SatMorningBreakfastCerealDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new SatMorningBreakfastCerealDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("SatMorningBreakfastCerealDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("SatMorningBreakfastCerealList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("SatMorningBreakfastCerealDetail");
        }
    }
}
