...
{
    public class GarfieldGarfieldViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "GarfieldGarfieldDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new GarfieldGarfieldDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("GarfieldGarfieldDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("GarfieldGarfieldList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("GarfieldGarfieldDetail");
        }
    }
}
